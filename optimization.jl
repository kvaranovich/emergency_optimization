...
function location_optimization_radius(mx::MapData, initial_positions::Vector{Int}, N_ITER = 100, t = 150.0)
    LAST_NODES = copy(initial_positions)
    NODES = []
    TIMES = []
    ...
    for i in 1:N_ITER
        println(i)
        CURR_NODES, CURR_TIME = optimization_step_radius(mx, LAST_NODES, t)
